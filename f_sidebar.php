    ...
    <div class="sidebar_blog_1">
        <div class="sidebar-header">
            <div class="logo_section">
                <a href="dash.php"><img class="logo_icon img-responsive" src="images/logo/logo_small.png"
                        alt="#" /></a>
            </div>
        </div>
    ...
    <div class="topbar">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="full">
                ...
                <div class="logo_section">
                    <a href="dash.php"><img class="img-responsive" src="images/logo/logo_big.png" alt="#" /></a>
                </div>
