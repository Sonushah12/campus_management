                                          ...
                                          <tbody>
                                            ...
                                            <?php
                                                ...
                                                <td class="project_progress">
                                                   <a href="reject.php?id=<?php echo $row['sid']; ?>">
                                                <button type="button" class="btn btn-reject btn-xs">Reject</button>
                                                                </a>
                                                
                                                  <a href="accept.php?id=<?php echo $row['sid']; ?>"> <button type="button" class="btn btn-success btn-xs">Accept</button></a>
                                                </td>
                                             </tr>
