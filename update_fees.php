...
<form method="POST" action="updatefees.php">
...
<br>
<center>
                    <h1>Update Fees Details</h1>
                    <p>Fees ID
                    <br>
                    <tr><td>
                    <input type="text" name="fid" value="<?php echo $id; ?>" class="number-input" readonly>
                     </tr></td>
                     <br><br> 
                    <tr><td>
                    <input type="number" name="amount" placeholder="Enter Fees Amount" class="number-input" value="<?php echo $fees_amount;?>"required>
                    </tr></td>

                    <br>
                    <br>
                    <tr><td>
                    <input type="number" name="year" placeholder="Enter Fees Year" class="number-input" value="<?php echo $year;?>"required>
                    </tr></td>
